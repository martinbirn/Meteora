    ...
    get() {
        ...
        _MaskIcon = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(7.5f, 7.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.275f, 6.773f)
                arcToRelative(7f, 7f, 0f, isMoreThanHalf = true, isPositiveArc = false, 0f, -13.546f)
                moveTo(4.187f, 0.966f)
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 7.627f, 14.069f)
