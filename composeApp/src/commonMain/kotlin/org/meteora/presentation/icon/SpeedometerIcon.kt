    ...
    get() {
        ...
        _SpeedometerIcon = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.39f, 0.39f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.527f, -0.02f)
                lineTo(7.547f, 7.31f)
                arcTo(0.91f, 0.91f, 0f, isMoreThanHalf = true, isPositiveArc = false, 8.85f, 8.569f)
                lineToRelative(3.434f, -4.297f)
                arcToRelative(0.39f, 0.39f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.029f, -0.518f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.672f, 15.78f)
                close()
                ...
                arcToRelative(7f, 7f, 0f, isMoreThanHalf = true, isPositiveArc = false, -12.002f, 0f)
            }
        }.build()
        return _SpeedometerIcon!!
    }
