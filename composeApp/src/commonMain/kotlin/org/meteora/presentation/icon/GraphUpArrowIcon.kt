...
val GraphUpArrowIcon: ImageVector
    get() {
        if (_GraphUpArrowIcon != null) {
            return _GraphUpArrowIcon!!
        }
        _GraphUpArrowIcon = ImageVector.Builder(
            name = "GraphUpArrow",
            defaultWidth = 16.dp,
            defaultHeight = 16.dp,
            viewportWidth = 16f,
...
private var _GraphUpArrowIcon: ImageVector? = null
